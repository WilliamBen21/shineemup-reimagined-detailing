...
const ServiceSection: React.FC<ServiceSectionProps> = ({ category }) => {
  ...
  return (
    <section className="mb-16 sm:mb-18 md:mb-20">
      <header className="flex items-center justify-center lg:justify-start mb-6 sm:mb-8 px-4 sm:px-0">
      ...
      <div className={`grid ${getGridCols()} gap-4 sm:gap-6 md:gap-8 px-2 sm:px-0 justify-items-center lg:justify-items-start`}>
